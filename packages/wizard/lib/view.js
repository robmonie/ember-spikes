...
ET.WizardView = Ember.View.extend({
  ...
  NavBottomView: Ember.View.extend({
    ...
    NextButton: Ember.Button.extend({
      ...
      isVisible: (function() {
        return this.getPath('parentView.parentView.currentPage') < (this.getPath('parentView.parentView.numberOfPages') - 1);
    ...
    PreviousButton: Ember.Button.extend({
      ...
      isVisible: (function() {
        return this.getPath('parentView.parentView.currentPage') > 1;
      }).property('parentView.parentView.currentPage'),
      click: function() {
